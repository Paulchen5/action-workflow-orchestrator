...
git switch --create ${release_branch} main2
...
git add package.json package-lock.json CHANGELOG.md VERSION
...
gh pr create --base main-test --head ${release_branch} --title "Release ${version}" --body "${changelog}"
